...
function Home() {
  ...
  return (
    <main style={{minHeight: "100vh", backgroundColor: "#0a0a6e"}}>

      {/* ── HERO ── */}
      <section className="relative bg-primary dark:bg-dark-nav overflow-hidden">

        {/* Faint watermark logo in bg */}
        <div className="absolute right-0 top-0 h-full w-1/2 flex items-center justify-end pr-8 pointer-events-none select-none opacity-10">
          <img src={logo} alt="" className="h-80 w-80 object-contain" />
        </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-20 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-shrink-0">
            <div className="bg-white/10 border border-white/20 rounded-3xl p-8 backdrop-blur-sm flex flex-col items-center gap-4 shadow-2xl">
              <img
                src={logo}
                alt="Phoenix Computers"
                className="h-36 w-36 object-contain bg-white rounded-2xl p-3 shadow-lg"
              />
              <p className="text-white font-black text-xl tracking-wide text-center">
                PHOENIX<br />COMPUTERS
              </p>
              <p className="text-blue-300 text-xs text-center tracking-wider">
                Consumables & Refilling Park
              </p>
            </div>
          </div>
      ...
      {/* ── CATEGORY ICON BAR ── */}
      <section className="bg-white dark:bg-dark-card border-b border-blue-100 dark:border-blue-900 shadow-sm sticky top-0 z-30">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-1 overflow-x-auto scrollbar-hide">
          {categories.map((cat) => (
            <a
              key={cat.label}
              href={`#${cat.label.toLowerCase()}`}
              className="flex flex-col items-center gap-1 px-4 py-2 rounded-xl hover:bg-brand-bg dark:hover:bg-dark-bg transition group flex-shrink-0"
            >
          ...
          {[
            {
              ...
              desc: "New, refurbished, and custom-built systems for home and business.",
              id: "laptops",
            },
            {
              icon: "📷",
              title: "CCTV Systems",
              desc: "Complete surveillance solutions — supply, installation & support.",
              id: "cctv",
            },
            {
              icon: "🖨️",
              title: "Printer Services",
              desc: "Printer repair, head reconditioning & laser toner refillings.",
              id: "printers",
            },
            {
              icon: "🔌",
              title: "Accessories & Consumables",
              desc: "Cables, cartridges, ink, and everything your setup needs.",
              id: "accessories",
            },
            {
              icon: "🌐",
              title: "Networking",
              desc: "Routers, switches, structured cabling and network setup.",
              id: "networking",
            },
            {
              icon: "🖱️",
              title: "Peripherals",
              desc: "Keyboards, mice, monitors, headsets and more.",
              id: "peripherals",
            },
            {
              icon: "🔋",
              title: "Ink & Toner Refilling",
              desc: "On-site refilling park for laser toner and ink cartridges.",
              id: "refilling",
            },
            {
              icon: "🛠️",
              title: "Repairs & Service",
              desc: "Hardware diagnostics, OS install, virus removal & data recovery.",
              id: "service",
            },
          ].map((item) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white dark:bg-dark-card border border-blue-100 dark:border-blue-900 rounded-2xl p-5 hover:shadow-xl hover:-translate-y-1 hover:border-primary dark:hover:border-blue-400 transition-all duration-300 group cursor-pointer"
            >
      ...
      {/* ── FOOTER ── */}
      <footer id="contact" className="bg-white dark:bg-dark-card border-t border-blue-100 dark:border-blue-900 py-12 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">

          {/* Company */}
          <div>
            <p className="text-xs font-bold text-primary dark:text-blue-300 uppercase tracking-widest mb-3">
              Company |
            </p>
            <div className="flex items-center gap-3 mb-3">
              <img src={logo} alt="Logo" className="h-10 w-10 object-contain bg-brand-bg dark:bg-dark-bg rounded-xl p-1" />
              <span className="font-black text-gray-800 dark:text-white text-sm">
                Phoenix Marketers
              </span>
            </div>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Laptops | Desktops | CCTV | Accessories | Refilling Park
            </p>
        ...
        <div className="max-w-6xl mx-auto mt-10 pt-6 border-t border-blue-100 dark:border-blue-900 text-center">
